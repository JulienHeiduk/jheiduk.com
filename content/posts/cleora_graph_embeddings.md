...
In summary, Cleora embeddings offer a versatile and scalable solution for modeling and analyzing complex relationships in diverse datasets. Its speed, stability, and compatibility across different data types make Cleora a valuable tool for tackling real-world challenges in numerous data-driven applications. In the next article we are going to talk about Pycleora, a python-package to use it. Let's focus on the use case recommender systems and see how to create [user's embeddings](https://jheiduk.com/posts/cleora_user_embeddings/).